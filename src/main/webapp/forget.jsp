...
<div class="main-content-agile">
    <div class="sub-main-w3">
        ...
        <div class="header-left-bottom agileinfo">
            <form action="user/userforgetPassword" method="post" >

                <div class="icon1">
                    <i class="fa fa-envelope" aria-hidden="true"></i>
                    <input type="email" placeholder="账号E-mail" required="" name="userE_mall"/>
                </div>
            <div class="icon1">
                <i class="fa fa-envelope" aria-hidden="true"></i>
            ...
            <div class="icon1">
                ...
                <div class="icon1">
                    <i class="fa fa-lock" aria-hidden="true"></i>
                    <input type="password" placeholder="新密码" required="" name="userpassword" />
                </div>
                <div class="bottom">
